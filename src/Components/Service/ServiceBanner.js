                        ...
                        <div className="col-lg-7 align-self-center">
                            <div className="about-us-info-wrap">
                                <div className="section-title-area ltn__section-title-2--- mb-20">
                                    ...
                                    <h1 className="section-title">Your faithful partners <br /> Medical Goods</h1>
                                    <p>
                                ...
                                <div className="btn-wrapper animated">
                                    <NavLink to="/about" className="theme-btn-1 btn btn-effect-1 text-uppercase">About Us</NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
